...
#consistencia visual
# re[620:5830,1:] = np.nan
# re[1995:6995,1:] = np.nan ; re[11411:15932,1:] = np.nan #recife
# re[11532:15766,1:] = np.nan
# re[11411:15932,1:] = np.nan
...
#retira os nan
ws1 = re[pl.find(pl.isnan(re[:,1])==False),1]
wg1 = re[pl.find(pl.isnan(re[:,2])==False),2]
...
#retira os nan
ws1 = sa[pl.find(pl.isnan(sa[:,1])==False),1]
wg1 = sa[pl.find(pl.isnan(sa[:,2])==False),2]
...
#retira os nan
ws1 = fl[pl.find(pl.isnan(fl[:,1])==False),1]
wg1 = fl[pl.find(pl.isnan(fl[:,2])==False),2]
...
#retira os nan
ws1 = rg[pl.find(pl.isnan(rg[:,1])==False),1]
wg1 = rg[pl.find(pl.isnan(rg[:,2])==False),2]
...
#retira os nan
at1 = re[pl.find(pl.isnan(re[:,4])==False),4]
wt1 = re[pl.find(pl.isnan(re[:,6])==False),6]
...
#retira os nan
at1 = sa[pl.find(pl.isnan(sa[:,4])==False),4]
wt1 = sa[pl.find(pl.isnan(sa[:,6])==False),6]
...
#retira os nan
at1 = fl[pl.find(pl.isnan(fl[:,4])==False),4]
wt1 = fl[pl.find(pl.isnan(fl[:,6])==False),6]
...
#retira os nan
at1 = rg[pl.find(pl.isnan(rg[:,4])==False),4]
wt1 = rg[pl.find(pl.isnan(rg[:,6])==False),6]
...
#retira os nan
pr1 = re[pl.find(pl.isnan(re[:,5])==False),5]
...
#retira os nan
pr1 = sa[pl.find(pl.isnan(sa[:,5])==False),5]
...
#retira os nan
pr1 = fl[pl.find(pl.isnan(fl[:,5])==False),5]
...
#retira os nan
pr1 = rg[pl.find(pl.isnan(rg[:,5])==False),5]
...
#retira os nan
hs1 = re[pl.find(pl.isnan(re[:,7])==False),7]
...
#retira os nan
hs1 = sa[pl.find(pl.isnan(sa[:,7])==False),7]
...
#retira os nan
hs1 = fl[pl.find(pl.isnan(fl[:,7])==False),7]
...
#retira os nan
hs1 = rg[pl.find(pl.isnan(rg[:,7])==False),7]
...
#retira os nan
tp1 = re[pl.find(pl.isnan(re[:,8])==False),8]
...
#retira os nan
tp1 = sa[pl.find(pl.isnan(sa[:,8])==False),8]
...
#retira os nan
tp1 = fl[pl.find(pl.isnan(fl[:,8])==False),8]
...
#retira os nan
tp1 = rg[pl.find(pl.isnan(rg[:,8])==False),8]
