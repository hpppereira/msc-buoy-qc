'''
Processamento dos dados baixados diretamente
do site do satelite ARGOS

O arquivo baixado vem com todas as boias
selecionadas no site

Ex de arquivo: 'ArgosData_2014_11_19_14_57_24.csv'
...
pathname = os.environ['HOME'] + '/Dropbox/lioc/dados/pnboia/argos_site/'
arqname = 'ArgosData_2014_11_19_14_57_24.csv'

#izabel
# pathname = os.environ['HOME'] + '/Projetos/Dropbox/LIOc/ww3br/Geral/dados/argos/'
